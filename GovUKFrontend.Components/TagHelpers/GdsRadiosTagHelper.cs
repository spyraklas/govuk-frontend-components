...
{
    [HtmlTargetElement("gds-radios")]
    public class GdsRadiosTagHelper : BaseTagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add the radios area
            var radiosAreaTag = new TagBuilder("div");
            string radiosSmallClass = Small ? "govuk-radios--small" : string.Empty;
            radiosAreaTag.AddCssClass($"govuk-radios {radiosSmallClass}");
            radiosAreaTag.Attributes.Add("data-module", "govuk-radios");
            radiosAreaTag.InnerHtml.AppendHtml(childContent);

            fieldTag.InnerHtml.AppendHtml(radiosAreaTag);
